...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/yaninyzwitty/go-live-counter/gen/outbox/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ProcessorServiceName = "outbox.v1.ProcessorService"
)
...
const (
	...
	ProcessorServiceProcessOutboxMessageProcedure = "/outbox.v1.ProcessorService/ProcessOutboxMessage"
)

// ProcessorServiceClient is a client for the outbox.v1.ProcessorService service.
...
// NewProcessorServiceClient constructs a client for the outbox.v1.ProcessorService service. By
...
func NewProcessorServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProcessorServiceClient {
	...
	processorServiceMethods := v1.File_outbox_v1_outbox_proto.Services().ByName("ProcessorService").Methods()
...
// ProcessOutboxMessage calls outbox.v1.ProcessorService.ProcessOutboxMessage.
...
// ProcessorServiceHandler is an implementation of the outbox.v1.ProcessorService service.
...
func NewProcessorServiceHandler(svc ProcessorServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/outbox.v1.ProcessorService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProcessorServiceHandler) ProcessOutboxMessage(context.Context, *connect.Request[v1.ProcessOutboxMessageRequest]) (*connect.Response[v1.ProcessOutboxMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("outbox.v1.ProcessorService.ProcessOutboxMessage is not implemented"))
}
